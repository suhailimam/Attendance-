                ...
                <div class="table">
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                            <span><a href='edit.php?id=" . $row["id"] . "' class='ri-edit-line edit'></a></span>
                            <span><a href='deleteVenue.php?id=" . $row["id"] . "' class='ri-delete-bin-line delete' onclick='return confirm(\"Are you sure you want to delete this record?\");'></a></span>
                          </td>";                            
                            echo "</tr>";
                        }
                    } else {
